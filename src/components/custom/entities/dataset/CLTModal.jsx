    ...
    <AppModal 
      ...
      <div>
        ...
        <Accordion defaultExpanded>
          ...
          <AccordionDetails>
            <p>Choose download options to bulk download files from your selected datasets. Your selection of files will generate a manifest file, which can be used with the SenNet Command Line Transfer (CLT) tool for downloading. An option to download a tsv file of the metadata is also available.</p>

            <p>To download the files included in the manifest file, install the SenNet CLT (if not already installed) and follow instructions for how to use it with the manifest file.</p>

          
            <p><LnkIc href='https://docs.sennetconsortium.org/libraries/clt/'  title='SenNet CLT Documentation' /></p>
        ...
        <Accordion defaultExpanded>
          ...
          <AccordionDetails>
            ...
            <h5>Raw Data</h5>
            <p>Raw data consists of files as originally submitted by the data submitters. Individuals files for raw data cannot be previewed or selected for the manifest download. You must download all raw files, and the total download size cannot be estimated.</p>
            <h5>Processed Data</h5>
            <p>Processed data includes files associated with data generated by HuBMAP using uniform processing pipelines or by an external processing approach. Only files centrally processed by HuBMAP are available for individual selection, which can be done in the Advanced Selections section below.</p>
            <hr />
