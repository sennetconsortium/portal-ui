    ...
    <AppModal 
      ...
      <div>
        ...
        <Accordion defaultExpanded>
          ...
          <AccordionDetails>
            <p>Choose download options to bulk download files from your selected datasets. Your selection of files will generate a manifest file, which can be used with the SenNet Command Line Transfer (CLT) tool for downloading.</p>

            <p>To download the files included in the manifest file, install the SenNet CLT (if not already installed) and follow instructions for how to use it with the manifest file. See the online Documentation for details.</p>
        ...
        <Accordion defaultExpanded>
          ...
          <AccordionDetails>
            ...
            <p>Processed data includes files associated with data generated by SenNet using uniform processing pipelines or by an external processing approach. Only files centrally processed by SenNet are available for individual selection, which can be done in the Advanced Selections section below.</p>
            <hr />
