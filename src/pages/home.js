            ...
            <div role='main' className='sui-layout snLanding'>
                <section aria-label='About SenNet' className='sui-layout-body__inner'>
                    <Card className='mt-4 p-3'>
                        ...
                        <Card.Body>
                            <p>The Cellular Senescence Network (SenNet) Program, supported by the NIH Common Fund, was
                                established to comprehensively identify and characterize the differences in senescent
                                cells across the body, across various states of human health, and across the lifespan.
                                SenNet is providing publicly accessible atlases of senescent cells, the differences
                                among them, and the molecules they secrete, using data collected from multiple human and
                                model organism tissues. To identify and characterize these rare cells, SenNet is
                                developing innovative tools and technologies that build upon previous advances in single
                                cell analysis, such as those from the Common Fund’s Human Biomolecular Atlas Program.
                                Lastly, SenNet is uniting cellular senescence researchers by developing common terms and
                        ...
                        <Row className={'smcFlex'}>
                            ...
                            <Col lg={3} className='smcHolder smcHolder--right smcHolder--hasSib smcHolder--w-sm-50'>
                                <SiteMapCard title={<div className={"d-flex d-flex-row justify-content-between"}>
                                    ...
                                    <div className={'text-center'}>
                                        <Button variant="primary" className={'w-75 fs-7 mx-auto'}
                                                href={'https://sennetconsortium.org/members/'}>Members Portal</Button>
                                    </div>
                                </SiteMapCard>
                            </Col>
                        </Row>
                        ...
                        <Card.Body>
                            <p> The SenNet Consortium has established comprehensive data use guidelines to ensure
                                ethical, effective, and <LnkIc href={'https://www.go-fair.org/fair-principles/'}
                                                               title='FAIR'/> utilization of its data by both internal
                                members and external researchers. For more information, read our <LnkIc
                                    title={'Data Use Policy'} href={'https://sennetconsortium.org/external-data-use/'}/>.
                            </p>
                        </Card.Body>
                    </Card>
                </section>
